...
public class FoodFragment extends BaseFragment {
    public static final String[] GUIDE_COVER_TITLE = new String[]{"本土特色美食"};
    public static final int[] GUIDE_COVER_IMG = new int[]{R.mipmap.food_baba1};
    ...
    protected void initViewsAndData(View view) {
        ...
        BaseQuickAdapter<GuideItem> quickAdapter2 = new BaseQuickAdapter<GuideItem>(R.layout.attraction_item, mDatas2) {
            ...
            protected void convert(BaseViewHolder baseViewHolder, GuideItem o) {
                ...
                baseViewHolder.setText(R.id.attraction_describe_txv, "餐厅 | ￥50");
    ...
    private void initData() {
        ...
        guideItem.setTitle("忠义小吃坊");
        guideItem.setDescribe(getString(R.string.restaurant_zhongyixiaochifang_detail));
        guideItem.setOthers(getString(R.string.restaurant_zhongyixiaochifang_others));
        guideItem.setTips(getString(R.string.restaurant_zhongyixiaochifang_tips));
        guideItem.setLatitude(100.2212);
        guideItem.setLongitude(26.8828);
        guideItem.setCoverId(R.mipmap.restaurant_zhongyixiaochifang);
